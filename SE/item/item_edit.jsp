                ...
                <form method="post" action = "item_update.jsp" onsubmit="return validateForm()" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="info" id="name_info" style="display:none;">
                            <ul>
								<li id="name_duplicate" class="valid"><strong>중복되지 않거나 기존의</strong> 물품명<br></li>
                                <li id="name_valid" class="valid"><strong>특수문자</strong>는 사용이 불가능합니다. </li>
                                <li id="name_length" class="valid">길이<strong>4 이상 20 이하</strong></li>
                            </ul>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="info" id="reg_info" style="display:none;">
                            <ul>
								<li id="reg_duplicate" class="valid"><strong>중복되지 않는</strong> 출원 번호 </li>
                            </ul>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="info" id="price_info" style="display:none;">
                            <ul>
                                <li id="price_valid" class="valid">  <strong>숫자</strong>만 입력 가능합니다.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <button type="submit" id="submit" class="btn btn-primary btn-lg btn-block login-button"> 물품 정보 수정 </button>
